    ...
    <section>
        <table id="table" data-auto data-table="{'passport/apps/data'|app}" data-sort="status,d">
            ...
            <tr>
                ...
                <th>说明</th>
                <th width="75" data-sort="status,d">状态</th>
                <th width="75" data-sort="ios,d">苹果</th>
                <th width="75" data-sort="ipad,d">iPad</th>
                <th width="75" data-sort="android,d">安卓</th>
                <th width="75" data-sort="pad,d">平板</th>
                <th width="75" data-sort="web,d">WEB</th>
                <th width="75" data-sort="pc,d">PC</th>
                <th width="75" data-sort="h5,d">H5</th>
                <th width="60"></th>
            </tr>
            </thead>
        </table>
