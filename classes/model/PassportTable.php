...
class PassportTable extends Table {
    ...
    public function updateAccount($data) {
        try {
            ...
            if ($id) {
                $data = apply_filter('passport\beforeUpdate', $data);
                $rst  = $data && $this->trans(function ($db) use ($data) {
                        $id = $data['id'];
                        ...
                        return $this->update($data, ['id' => $data['id']]) && apply_filter('passport\onUpdated', true, $data);
                    }, $this->errors);
    ...
    public function newAccount($data) {
        $data = apply_filter('passport\beforeCreate', $data);
